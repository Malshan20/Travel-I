    ...
    <div className="min-h-screen bg-gradient-to-br from-[#3E5F44]/5 to-[#8fbc8f]/10 flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">Join thousands of travelers discovering the world with AI</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link href="/auth/login" className="font-semibold text-[#3E5F44] hover:text-[#2f4a35] transition-colors">
                Sign in
              </Link>
            </p>
          </div>

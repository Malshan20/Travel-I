  ...
  return (
    <div className="space-y-6">
      ...
      <form action={formAction} className="space-y-6">
        ...
        {/* Features reminder */}
        <div className="mt-6 p-4 bg-[#0077b6]/5 rounded-xl">
          <h4 className="text-sm font-semibold text-gray-900 mb-2">What you'll get:</h4>
          <ul className="text-xs text-gray-600 space-y-1">
            <li>• AI-powered hotel recommendations</li>
            <li>• Smart travel directions and routes</li>
            <li>• Personal AI travel chat assistant</li>
            <li>• Save and organize your discoveries</li>
          </ul>
        </div>
      </form>
    </div>
